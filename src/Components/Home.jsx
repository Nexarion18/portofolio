...
const Home = () => {
  return (
    <div id="home" className="flex flex-col w-3/4 mx-auto sm:flex-row items-center py-30 justify min-h-screen gap-3 md:flex-row justify-start px-20 lg:px-4">
      ...
      <div className="px-10 mt-5 md:mb-24 md:mt-0 lg:mt-0 ">
        <GlareCard>
